  ...
  <div>
    <header class="header">
      <h1 class="header-title">
        <a href="/">typesense-vue-instanstantsearch-demo</a>
      </h1>
      <p class="header-subtitle">
        using
        <a href="https://github.com/algolia/vue-instantsearch">Vue InstantSearch + Typesense Instantsearch adapter</a>
      </p>
    </header>
            ...
            <ais-hits>
              <template slot="item" slot-scope="{ item }">
                <article>
                  ...
                  <h1>
                    <ais-highlight :hit="item" attribute="title" class="hit-name" />
                  </h1>
                  <div class="hit-authors">
                    <span v-for="(fieldValue, index) in item['authors']" :key="`highlight-${fieldValue}-${index}`">
